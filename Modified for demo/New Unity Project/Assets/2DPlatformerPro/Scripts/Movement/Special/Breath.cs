...
namespace PlatformerPro
{
	...
	public class Breath : MonoBehaviour 
	{
		...
		virtual protected bool HoldingBreath()
		{
			...
			if (loseBreathMovement == null) return true;
			if (character.ActiveMovement == loseBreathMovement.Implementation)
			{
				if (cachedSwimMovement != null) return !cachedSwimMovement.OnSurface;
				return true;
			}
			return false;
		}
