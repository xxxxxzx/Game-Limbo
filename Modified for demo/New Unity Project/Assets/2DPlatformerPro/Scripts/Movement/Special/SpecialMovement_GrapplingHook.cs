...
//			}
		...
		virtual protected void DrawRope()
		{
			...
			ropeGo.transform.position = (Vector2)character.Transform.position + HandOffset + (direction * (distance / 2.0f));
			ropeGo.transform.localScale = new Vector3(distance, ropeGo.transform.localScale.y, ropeGo.transform.localScale.z);
			ropeGo.SetActive (true);
	
			// TODO A rope type that doesn't stretch
		}
